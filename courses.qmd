...
including participants from outside your institution. If the training is intended specifically for your team
or a small, invite-only audience, we would be happy to discuss a more tailored format.
...
<details>
<summary style="line-height: 0.4; margin: 0; padding: 2px 0;">
...
- <font size="+1">ParaView scripting</font>
- <font size="+1">ParaView animation</font>
- <font size="+1">Programmable Filter / Source in ParaView</font>
- <font size="+1">Graph visualization</font>
- <font size="+1">In-situ visualization with Catalyst2</font>
- <font size="+1">Volumetric visualization and data analysis with *yt*</font>
- <font size="+1">Plotting in Python with  Matplotlib</font>
- <font size="+1">Plotting in Python with Plotly</font>
- <font size="+1">Interactive web dashboards with Plotly Dash</font>
- <font size="+1">Modern tools for web visualization, focusing on trame.app and the VTK ecosystem</font>
...
<div style="height: 0px;"></div>
- <font size="+1">Bash scripting for beginners</font>
...
- <font size="+1">Intro to HPC for R users</font>
- <font size="+1">Distributed-memory programming with MPI</font>
- <font size="+1">Shared-memory programming with OpenMP</font>
- <font size="+1">Automating your workflows with *make*</font>
- <font size="+1">Debugging and memory debugging</font>
...
- <font size="+1">Typesetting with Quarto</font>
...
- <font size="+1">`uv` package manager</font>
- <font size="+1">Next-gen Python notebooks with Marimo</font>

### R

<div style="height: 8px;"></div>

- <font size="+1">Introduction and advanced topics in R programming</font>
- <font size="+1">Intro to HPC for R users</font>
...
- <font size="+1">High-level parallel stencil computations on CPUs and GPUs in Julia</font>
...
- <font size="+1">Setting a virtual machine on an Alliance cloud system</font>
- <font size="+1">Command-line OpenStack</font>
...
<div style="height: 0px;"></div>
- <font size="+1">A great Git UI: Lazygit</font>
- <font size="+1">Distributed file storage with git-annex</font>
- <font size="+1">Version control of large and distributed datasets with DataLad</font>
- <font size="+1">What format to choose to save your data</font>
- <font size="+1">Managing large hierarchical datasets with PyTables</font>
- <font size="+1">Globus command line for file transfer</font>
