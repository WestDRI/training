...
| TOPIC | DATE | SPEAKER |
| -------------- | -------------- | ----------------- |
| [<span style="color:blue">High-level parallel stencil computations on CPUs and GPUs in Julia</span>](/programming#julia) | Jan-21 | Alex Razoumov | <!-- ParallelStencil.jl -->
| [<span style="color:blue">Modern shell utilities</span>](/getting-started#linux) | Jan-28 | Marie-Hélène Burle |
| [<span style="color:blue">Running parallel Ray workflows across multiple cluster nodes</span>](/programming#python) | Feb-11 | Alex Razoumov |
| [<span style="color:blue">Bayesian inference in JAX</span>](/tools/pp) | Feb-25 | Marie-Hélène Burle |
| [<span style="color:blue">Compliance or chaos: a research assessment survival guide</span>](/tools/cyber) | Mar-25 | Luc Letarte &<br> Jessica Galo |
| [<span style="color:blue">Introduction to Globus</span>](/tools/rdm) | Apr-08 | Ben Lai &<br> Michael Tang |
| [<span style="color:blue">Cybersecurity hygiene</span>](/tools/cyber) | Apr-22 | Scott Baker |
| [<span style="color:blue">Managing Python packages, versions, and projects with uv</span>](/programming#python) | May-06 | Marie-Hélène Burle |
| [<span style="color:blue">Workflow hacks for large datasets in HPC</span>](/tools/rdm) | May-20 | Alex Razoumov |
...
| EVENT | DATE | VENUE |
| ----- | ---- | ----- |
| [Univ. of Alberta Spring Bootcamp](https://www.ualberta.ca/en/information-services-and-technology/research-computing/bootcamps.html){target="_blank"} | Starts May-02 | Online |
